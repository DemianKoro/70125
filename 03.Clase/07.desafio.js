class TicketManager{
    ...
    ponerEventoEnGira(id_evento,nNombre, nLocalidad,nFecha){
        let evento = this.traerEvento(id_evento);
...
ticketManager.agregarEvento("Baradero Rock", "Baradero", 120500);
ticketManager.agregarEvento("San Pedro Rock", "San Pedro", 90100);

ticketManager.agregarUsuario(1,1)
ticketManager.agregarUsuario(1,2)
ticketManager.ponerEventoEnGira(2,"Ramallo Rock","Ramallo", "11-12-2024");
